  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const electronicsProducts = res.data.filter(product => product.category === "Appliances");
        ...
        {Object.keys(categories).length > 0 ? (
          Object.keys(categories).map((category) => (
            <div key={category} className="mb-8">
              <h1 className="text-2xl text-center font-semibold text-gray-800 bg-gray-100 p-4 rounded-lg">
                {category}
              </h1>
